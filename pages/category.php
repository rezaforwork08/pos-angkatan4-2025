                    ...
                    <table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="?page=tambah-category&edit=<?php echo $category['id'] ?>" class="btn btn-success btn-sm">
                                        <i class="bi bi-pencil"></i>
                                    </a>
                                    <form class="d-inline" action="?page=category&delete=<?php echo $category['id'] ?>" method="post" onclick="return confirm('Apakah ingin di hapus??')">
